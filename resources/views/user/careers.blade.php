...
@section('content')
    ...
    <section class="career-boxx ptb-128">
      <div class="container">        
        <div class="row">
          <div class="col-12">            
            <div class="mxw-800 text-center m-auto">
              ...
              <div class="career-card-box mb-64">
                <div class="career-card">
                  <img src="{{ URL::asset('dist/images/career/Icon-1.png') }}" class="img-fluid career-icon" alt="...">
                ...
                <div class="career-card">
                  <img src="{{ URL::asset('dist/images/career/Icon-2.png') }}" class="img-fluid career-icon" alt="...">
                  <div class="career-card-body pt-32">
              ...
              <div class="career-card-box">
                <div class="career-card">
                  <img src="{{ URL::asset('dist/images/career/Icon-3.png') }}" class="img-fluid career-icon" alt="...">
                  <div class="career-card-body pt-32">
                ...
                <div class="career-card">
                  <img src="{{ URL::asset('dist/images/career/Icon-4.png') }}" class="img-fluid career-icon" alt="...">
                  <div class="career-card-body pt-32">
