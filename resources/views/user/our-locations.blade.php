...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="mxw-800">
                        <h1>Our Locations</h1>
                        <h6>With a network of gyms and venue partners, we provide convenient access to top-notch facilities and programs designed to help you reach your fitness goals.</h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="our-locations" class="gallery ptb-128">
      <div class="container">
        <div class="mb-64">
            ...
            <div class="tab-content" id="nav-tabContent">
              ...
              <div class="tab-pane fade show active" id="locations-all" role="tabpanel" aria-labelledby="locations-all-tab">
                <div class="row mb-64">
                  <div class="col-md-3">
                    ...
                    <div class="card btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop-01">
                      <img src="{{ URL::asset('dist/images/location/location-1.png') }}" class="img-fluid" alt="...">
                      <div class="card-body">
                      ...
                      <div class="modal-dialog mxw-800 text-center">
                        <div class="modal-content ptb-48-64">
                          ...
                          <div class="loc-model-body">
                            <div class="loc-model-img mb-24"><img src="{{ URL::asset('dist/images/location/mandarin-oriental.png') }}" class="img-fluid" alt=""></div>
                            <h4>Mandarin Oriental</h4>
                            <h6 class="mb-24">Msheireb <span class="px-3">•</span><span class="pe-2">View map</span><span><img src="{{ URL::asset('dist/images/arrow-top.png') }}" class="img-fluid" alt=""></span></h6>
                            ...
                            <div class="location-video">                              
                              <video autoplay="" loop="" controls="" poster="{{ URL::asset('dist/images/location/location-video-1.png') }}>
                  ...
                  <div class="col-md-3">
                    <div class="card btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop-02">
                      <img src="{{ URL::asset('dist/images/location/location-2.png') }}" class="img-fluid" alt="...">
                      <div class="card-body">
                    ...
                    <div class="modal fade" id="staticBackdrop-02" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdrop-02Label" aria-hidden="true">
                      <div class="modal-dialog mxw-800 text-center">
                        <div class="modal-content ptb-88-98">
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                          <div class="loc-model-body">
                            <div class="loc-model-img mb-24"><img src="{{ URL::asset('dist/images/location/mandarin-oriental.png') }}" class="img-fluid" alt=""></div>
                            ...
                            <div class="location-video">
                              <img src="{{ URL::asset('dist/images/location/location-video-1.png') }}" class="img-fluid" alt="">
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="col-md-3">
                    <div class="card">
                      <img src="{{ URL::asset('dist/images/location/location-3.png') }}" class="img-fluid" alt="...">
                      <div class="card-body">
                  ...
                  <div class="col-md-3">
                    <div class="card">
                      <img src="{{ URL::asset('dist/images/location/location-4.png') }}" class="img-fluid" alt="...">
                      <div class="card-body">
                ...
                <div class="row mb-64">
                  <div class="col-md-3">
                    <div class="card">
                      <img src="{{ URL::asset('dist/images/location/location-5.png') }}" class="img-fluid" alt="...">
                      <div class="card-body">
                  ...
                  <div class="col-md-3">
                    <div class="card">
                      <img src="{{ URL::asset('dist/images/location/location-6.png') }}" class="img-fluid" alt="...">
                      <div class="card-body">
                  ...
                  <div class="col-md-3">
                    <div class="card">
                      <img src="{{ URL::asset('dist/images/location/location-7.png') }}" class="img-fluid" alt="...">
                      <div class="card-body">
                  ...
                  <div class="col-md-3">
                    <div class="card">
                      <img src="{{ URL::asset('dist/images/location/location-8.png') }}" class="img-fluid" alt="...">
                      <div class="card-body">
                ...
                <div class="row mb-64">
                  <div class="col-md-3">
                    <div class="card">
                      <img src="{{ URL::asset('dist/images/location/location-9.png') }}" class="img-fluid" alt="...">
                      <div class="card-body">
              ...
              <div class="tab-pane fade" id="loc-arts" role="tabpanel" aria-labelledby="loc-arts-tab">
                <div class="row mb-64">
                  <div class="col-md-3">
                    <div class="card">
                      <img src="{{ URL::asset('dist/images/team/Checker.png') }}" class="img-fluid" alt="...">
                      <div class="card-body">
                        <h5 class="card-title">Firstname Lastname</h5>
                        <p class="card-text">Specializations</p>                
                      </div>
    ...
    <section class="evole-map">
      <div id="map">
        <img src="{{ URL::asset('dist/images/location/map.png') }}" class="img-fluid" alt="">
      </div>
    </section>
