                            ...
                            <div class="booking-details mb-64">
                                ...
                                <div class="log-group-box">
                                    <div class="log-group mb-32 w-100">
                                        ...
                                        <div class="log-input"><input type="text" placeholder="Enter your full name">
                                        </div>
                                    </div>
                                </div>
                                <div class="log-group-box">
                                    ...
                                    <div class="log-group mb-32 w-50">
                                        ...
                                        <div class="log-input"><input type="tel" placeholder="00000000"></div>
                                        <!-- optional -->
                                    </div>
                                </div>

                                <div class="log-group-box">
                                    <div class="mb-16"><label for="choose-one-monday">Choose one of the available Mondays
                                            in July 2024 to attend the class:</label></div>
                                </div>
                            ...
                            <div class="payment-information">
                                ...
                                <div class="log-group-box mb-64">
                                    <div class="log-group w-50">
                                        ...
                                        <div class="log-input"><input type="text" placeholder="0000 0000 0000 0000">
                                        </div>
                                    </div>
                                    <div class="log-group w-25">
                                        <div class="log-label"><label for="card-expiry-date">Card Expiry Date</label>
                                        </div>
