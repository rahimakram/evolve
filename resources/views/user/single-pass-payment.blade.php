            ...
            <div class="row">
                <div class="col-12">
                    <div class="mxw-800 m-auto">
                        ...
                        <form action="{{ route('single.payment.process', $timeline->id) }}" id="singlePaymentForm"
                            method="POST">
                            @csrf
                            <div class="booking-details mb-64">
                                ...
                                <div class="log-group-box">
                                    <div class="mb-16">
                                        <label for="choose-one-monday">Choose one of the available
                                    ...
                                    <div class="log-group mb-32 w-100">
                                        ...
                                        <div class="log-input">
                                            <input type="number" id="Attendees" name="Attendees"
                                                value="{{ old('Attendees') ? old('Attendees') : 1 }}" min="1"
                                                placeholder="1">
                                        </div>
                                        @error('Attendees')
                                            <small class="text-danger">{{ $message }}</small>
                                ...
                                <div class="qar-50 d-flex align-items-baseline">
                                    <input type="hidden" name="totalAmount"
                                        value="{{ old('totalAmount') ? old('totalAmount') : $timeline->single_pass_price }}"
                                        id="totalAmount">
                                    <h5 class="text-black">QAR</h5>
                                    <h3 class="text-black" id="totalAmountDisplay">
                                        {{ old('totalAmount') ? old('totalAmount') : $timeline->single_pass_price }}</h3>
                                </div>
                                @error('totalAmount')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="payment-information">
                                ...
                                <div class="log-group-box mb-64">
                                    <div class="log-group w-50">
                                        ...
                                        <div class="log-input">
                                            <input type="text" name="card_number" name="card_number"
                                ...
                                <div class="log-group-box mb-64">
                                    <div class="log-group d-flex">
                                        ...
                                        <label for="read-carefully">I have read and understood the <span
                                                ...
                                                data-bs-target="#staticBackdrop-901">Terms & Conditions</span></label>
                                        <div class="modal fade" id="staticBackdrop-901" data-bs-backdrop="static"
                                            data-bs-keyboard="false" tabindex="-1"
                                            aria-labelledby="staticBackdrop-901Label" aria-hidden="true">
        ...
        $(document).ready(function() {
            $('#Attendees').on('input', function() {
                var attendeeValue = parseInt($(this).val()) ||
                    1;
                var costPerAttendee = {{ $timeline->single_pass_price }};
