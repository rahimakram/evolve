...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2s">
                    ...
                    <div class="mxw-800">
                        <h1>Contact Us</h1>
                        <p>Please don't hesitate to reach out to us with any questions, comments, or concerns. Our team is here to assist you and will respond promptly to your message. You can contact us via the form below or directly through email. We look forward to hearing from you!</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="contact-boxx ptb-128 wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2s">
      <div class="container">
        <div class="row text-center">
          <div class="col-md-4 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="2s">
            <div class="cont-card">
              <img src="{{ URL::asset('dist/images/contact/mail.png') }}" class="img-fluid mb-16" alt="...">
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="2s">
            <div class="cont-card">
              <img src="{{ URL::asset('dist/images/contact/building-office.png') }}" class="img-fluid mb-16" alt="...">
              <div class="cont-card-body">
                <h5>Office</h5>
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="2s">
            <div class="cont-card">
              <img src="{{ URL::asset('dist/images/contact/phone.png') }}" class="img-fluid mb-16" alt="...">
              <div class="cont-card-body">
    ...
    <section class="contact-form ptb-128 wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2s">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
