              ...
              <div class="tab-pane fade show active" id="locations-all" role="tabpanel" aria-labelledby="locations-all-tab">
                ...
                <div class="row mb-64">
                  ...
                  <div class="col-md-3 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="2s">
                    <div class="card">
                      <div class="card-img-box">
                      <img src="{{ URL::asset('dist/images/location/location-10.png') }}" class="img-fluid" alt="...">
                      </div>
                      <div class="card-body">
                  ...
                  <div class="col-md-3 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="2s">
                    <div class="card">
                      <div class="card-img-box">
                      <img src="{{ URL::asset('dist/images/location/location-11.png') }}" class="img-fluid" alt="...">
                      </div>
                      <div class="card-body">
                  ...
                  <div class="col-md-3 wow fadeInUp" data-wow-delay="700ms" data-wow-duration="2s">
                    <div class="card">
                      <div class="card-img-box">
                      <img src="{{ URL::asset('dist/images/location/location-12.png') }}" class="img-fluid" alt="...">
                      </div>
                      <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-3 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="2s">
                    <div class="card">
                      <div class="card-img-box">
                      <img src="{{ URL::asset('dist/images/location/location-13.png') }}" class="img-fluid" alt="...">
                      </div>
                      <div class="card-body">
                  ...
                  <div class="col-md-3 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="2s">
                    <div class="card">
                      <div class="card-img-box">
                      <img src="{{ URL::asset('dist/images/location/location-14.png') }}" class="img-fluid" alt="...">
                      </div>
                      <div class="card-body">
