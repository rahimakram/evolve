            ...
            <div class="card">
                <div class="card-body">
                            ...
                            <tbody>
                                @forelse ($specializations as $specialization)
                                    <tr>
                                        ...
                                        <td>{{ $specialization->specialization_name }}</td> <!-- Trainer's name -->
                                        ...
                                        <td>
                                            @if ($specialization->status == 'Y')
                                                ...
                                                <form style="display:none"
                                                    ...
                                                    action="{{ route('admin.specialization.deactivate', $specialization->id) }}"
                                                    method="post">
                                                    @csrf
                                                </form>
                                            @else
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        {{ $specializations->onEachSide(1)->links('pagination::bootstrap-5') }}
