                ...
                <div class="card-body">
                    <div class="invoice-title">
                        ...
                        <div class="auth-logo mb-4">
                            <img src="{{ URL::asset('build/images/logo.webp') }}" alt="logo" class="auth-logo-dark" height="20" />
                            <img src="{{ URL::asset('build/images/logo.webp') }}" alt="logo" class="auth-logo-light" height="20" />
                        </div>
                    </div>
                    <hr>
                    <div class="row">
