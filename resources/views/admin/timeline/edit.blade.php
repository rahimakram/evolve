                    ...
                    <form method="post" action="{{ route('admin.timeline.update', $timeline->id) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($timeline->image)
                                    <img id="image-preview" src="{{ asset('storage/' . $timeline->image) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="time" name="start_time"
                                        value="{{ old('start_time') ? old('start_time') : \Carbon\Carbon::parse($timeline->start_time)->format('H:i:s') }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="time" name="end_time"
                                        value="{{ old('end_time') ? old('end_time') : \Carbon\Carbon::parse($timeline->end_time)->format('H:i:s') }}"
                                        id="example-time-input">
                                </div>
                            </div>
                        </div>
