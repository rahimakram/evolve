                    ...
                    <div class="col-lg-12">
                        <div class="text-center mb-5 text-muted">
                            <a href="index" class="d-block auth-logo">
                                <img src="{{ URL::asset('build/images/logo.webp') }}" alt="" height="20" class="auth-logo-dark mx-auto">
                                <img src="{{ URL::asset('build/images/logo.webp') }}" alt="" height="20" class="auth-logo-light mx-auto">
                            </a>
