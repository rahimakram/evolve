...
unset($__sessionArgs); ?>
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                ...
                                <a href="<?php echo e(route('admin.profession.add')); ?>"
                                    class="btn btn-success btn-rounded waves-effect waves-light addContact-modal mb-2"><i
                                        class="mdi mdi-plus me-1"></i> Create Profession</a>
                            </div>
                        </div><!-- end col-->
                    </div>
                    <!-- end row -->
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $professions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profession): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($profession->profession_name); ?></td> <!-- Trainer's name -->


                                        <td>
                                            <?php if($profession->status == 'Y'): ?>
                                                <!-- Deactivate Button -->
                                                <button onclick="confirmDeactivate(<?php echo e($profession->id); ?>)" type="button"
                                                    class="btn btn-sm btn-danger waves-effect waves-light">
                                                    <i class="bx bx-block font-size-16 align-middle me-2"></i> Deactivate
                                                </button>
                                                <form style="display:none"
                                                    id="deactivate_trainer_form_<?php echo e($profession->id); ?>"
                                                    action="<?php echo e(route('admin.profession.deactivate', $profession->id)); ?>"
                                                    method="post">
                                                    <?php echo csrf_field(); ?>
                                                </form>
                                            <?php else: ?>
                                                <!-- Activate Button -->
                                                <button onclick="confirmActivate(<?php echo e($profession->id); ?>)" type="button"
                                                    class="btn btn-sm btn-success waves-effect waves-light">
                                                    <i class="bx bx-check-circle font-size-16 align-middle me-2"></i>
                                                    Activate
                                                </button>
                                                <form style="display:none" id="activate_trainer_form_<?php echo e($profession->id); ?>"
                                                    action="<?php echo e(route('admin.profession.activate', $profession->id)); ?>"
                                                    method="post">
                                                    <?php echo csrf_field(); ?>
                                                </form>
                                            <?php endif; ?>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('admin.profession.edit', $profession->id)); ?>"
                                                class="btn btn-sm btn-success waves-effect waves-light">
                                                <i class="bx bx-edit font-size-16 align-middle me-2"></i> Edit
                                            </a>
                                            <button type="button" onclick="confirmDelete(<?php echo e($profession->id); ?>)"
                                                class="btn btn-sm btn-danger waves-effect waves-light">
                                                <i class="bx bx-trash font-size-16 align-middle me-2"></i> Delete
                                            </button>
                                            <form style="display:hidden" id="delete_trainer_form_<?php echo e($profession->id); ?>"
                                                action="<?php echo e(route('admin.profession.delete', $profession->id)); ?>"
                                                method="post">
                                                <?php echo csrf_field(); ?>
                                            </form>
                                        </td>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <?php echo e($professions->onEachSide(1)->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views\admin\profession\index.blade.php ENDPATH**/ ?>