...
<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.Blog_Grid'); ?> <?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>

<?php $__env->startComponent('admin.components.breadcrumb'); ?>
<?php $__env->slot('li_1'); ?> Blog <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> Blog Grid <?php $__env->endSlot(); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="card p-1 border shadow-none">
                                                ...
                                                <div class="position-relative">
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" alt="" class="img-thumbnail">
                                                </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="card p-1 border shadow-none">
                                                ...
                                                <div class="position-relative">
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-6.jpg')); ?>" alt="" class="img-thumbnail">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="card p-1 border shadow-none">
                                                ...
                                                <div class="position-relative">
                                                    <img src="<?php echo e(URL::asset('build/images/small/img-1.jpg')); ?>" alt="" class="img-thumbnail">
                                                </div>
                ...
                <div>
                    ...
                    <ul class="list-unstyled fw-medium">
                        <li><a href="#" class="text-muted py-2 d-block"><i class="mdi mdi-chevron-right me-1"></i> 2020
                                <span class="badge badge-soft-success badge-pill float-end ms-1 font-size-12">03</span></a>
                        </li>
                        <li><a href="#" class="text-muted py-2 d-block"><i class="mdi mdi-chevron-right me-1"></i> 2019
                                <span class="badge badge-soft-success badge-pill float-end ms-1 font-size-12">06</span></a>
                        </li>
                        <li><a href="#" class="text-muted py-2 d-block"><i class="mdi mdi-chevron-right me-1"></i> 2018
                                <span class="badge badge-soft-success badge-pill float-end ms-1 font-size-12">05</span></a>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <a href="javascript: void(0);" class="list-group-item text-muted py-3 px-2">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-3">
                                    <img src="<?php echo e(URL::asset('build/images/small/img-7.jpg')); ?>" alt="" class="avatar-md h-auto d-block rounded">
                                </div>
                        ...
                        <a href="javascript: void(0);" class="list-group-item text-muted py-3 px-2">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-3">
                                    <img src="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>" alt="" class="avatar-md h-auto d-block rounded">
                                </div>
                                <div class="flex-grow-1 overflow-hidden">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views\admin\blog-grid.blade.php ENDPATH**/ ?>