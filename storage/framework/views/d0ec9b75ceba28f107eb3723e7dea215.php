                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $trainers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trainer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td><img class="rounded-circle header-profile-user"
                                                src="<?php echo e(URL::asset('storage/' . $trainer->avatar)); ?>" alt="Header Avatar">
                                        </td>
                                        <td><?php echo e($trainer->name); ?></td>
                                        <td><?php echo e($trainer->contact ? $trainer->contact : 'N/A'); ?></td>
                                        <td><?php echo e($trainer->email ?? 'N/A'); ?></td>
                                        <td>
                                        ...
                                        <td>
                                            <?php if($trainer->status == 'Y'): ?>
                                                ...
                                                <form style="display:none"
                                                    id="deactivate_trainer_form_<?php echo e($trainer->u_id); ?>"
