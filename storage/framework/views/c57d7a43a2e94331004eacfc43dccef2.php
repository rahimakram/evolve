...
unset($__sessionArgs); ?>
                    ...
                    <form method="post" action="<?php echo e(route('admin.activity.create')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="activity_name" name="activity_name"
                                        placeholder="Enter Your Name" value="<?php echo e(old('activity_name')); ?>">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views/admin/activity/add.blade.php ENDPATH**/ ?>