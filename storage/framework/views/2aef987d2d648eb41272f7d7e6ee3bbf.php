    ...
    <section class="gallery ptb-64">
      <div class="container">
        ...
        <div class="row mb-64">
          <div class="col-md-4">
            <div class="card">
              <img src="./dist/images/wellness/wellness-1.png" class="img-fluid" alt="...">
              <div class="card-body">
          ...
          <div class="col-md-4">
            <div class="card">
              <img src="./dist/images/wellness/wellness-2.png" class="img-fluid" alt="...">
              <div class="card-body">
          ...
          <div class="col-md-4">
            <div class="card">
              <img src="./dist/images/wellness/wellness-3.png" class="img-fluid" alt="...">
              <div class="card-body">
        ...
        <div class="row mb-64">
          <div class="col-md-4">
            <div class="card">
              <img src="./dist/images/wellness/wellness-4.png" class="img-fluid" alt="...">
              <div class="card-body">
          ...
          <div class="col-md-4">
            <div class="card">
              <img src="./dist/images/wellness/wellness-5.png" class="img-fluid" alt="...">
              <div class="card-body">
          ...
          <div class="col-md-4">
            <div class="card">
              <img src="./dist/images/wellness/wellness-6.png" class="img-fluid" alt="...">
              <div class="card-body">
        ...
        <div class="row mb-64">
          ...
          <div class="col-md-4">
            <div class="card">
              <img src="./dist/images/wellness/wellness-12.png" class="img-fluid" alt="...">
              <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card">
              <img src="./dist/images/wellness/wellness-13.png" class="img-fluid" alt="...">
              <div class="card-body">
