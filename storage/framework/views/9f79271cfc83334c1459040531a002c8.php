        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="<?php echo e(route('admin.profession.update', $profession->id)); ?>"
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="profession_name" name="profession_name"
                                        ...
                                        value="<?php echo e(old('profession_name') ? old('profession_name') : $profession->profession_name); ?>">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views\admin\profession\edit.blade.php ENDPATH**/ ?>