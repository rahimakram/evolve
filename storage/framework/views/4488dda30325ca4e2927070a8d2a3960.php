...
<body data-bs-spy="scroll" data-bs-target="#topnav-menu" data-bs-offset="60">
    ...
    <nav class="navbar navbar-expand-lg navigation fixed-top sticky">
        <div class="container">
            <a class="navbar-logo" href="index">
                <img src="<?php echo e(URL::asset('build/images/logo.webp')); ?>" alt="" height="19"
                    ...
                    <div class="owl-carousel owl-theme clients-carousel" id="clients-carousel" dir="ltr">
                        <div class="item">
                            <div class="client-images">
                                <img src="<?php echo e(URL::asset('build/images/clients/1.png')); ?>" alt="client-img"
                                    class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                        <div class="item">
                            <div class="client-images">
                                <img src="<?php echo e(URL::asset('build/images/clients/2.png')); ?>" alt="client-img"
                                    class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                        <div class="item">
                            <div class="client-images">
                                <img src="<?php echo e(URL::asset('build/images/clients/3.png')); ?>" alt="client-img"
                                    class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                        <div class="item">
                            <div class="client-images">
                                <img src="<?php echo e(URL::asset('build/images/clients/4.png')); ?>" alt="client-img"
                                    class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                        <div class="item">
                            <div class="client-images">
                                <img src="<?php echo e(URL::asset('build/images/clients/5.png')); ?>" alt="client-img"
                                    class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                        <div class="item">
                            <div class="client-images">
                                <img src="<?php echo e(URL::asset('build/images/clients/6.png')); ?>" alt="client-img"
                                    class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row align-items-center pt-4">
                <div class="col-md-6 col-sm-8">
                    <div>
                        <img src="<?php echo e(URL::asset('build/images/crypto/features-img/img-1.png')); ?>" alt=""
            ...
            <div class="row align-items-center mt-5 pt-md-5">
                ...
                <div class="col-md-6  col-sm-8 ms-md-auto">
                    <div class="mt-4 me-md-0">
                        <img src="<?php echo e(URL::asset('build/images/crypto/features-img/img-2.png')); ?>" alt=""
                            class="img-fluid mx-auto d-block">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-sm-6">
                    <div class="blog-box mb-4 mb-xl-0">
                        <div class="position-relative">
                            <img src="<?php echo e(URL::asset('build/images/crypto/blog/img-1.jpg')); ?>" alt=""
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="blog-box mb-4 mb-xl-0">
                        ...
                        <div class="position-relative">
                            <img src="<?php echo e(URL::asset('build/images/crypto/blog/img-2.jpg')); ?>" alt=""
                                class="rounded img-fluid mx-auto d-block">
                            <div class="badge bg-success blog-badge font-size-11">Cryptocurrency</div>
                        </div>
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="blog-box mb-4 mb-xl-0">
                        <div class="position-relative">
                            <img src="<?php echo e(URL::asset('build/images/crypto/blog/img-3.jpg')); ?>" alt=""
                                class="rounded img-fluid mx-auto d-block">
                            <div class="badge bg-success blog-badge font-size-11">Cryptocurrency</div>
                        </div>
    ...
    <footer class="landing-footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="mb-4">
                        <img src="<?php echo e(URL::asset('build/images/logo.webp')); ?>" alt="" height="20">
                    </div>
    ...
    <script src="<?php echo e(URL::asset('build/libs/jquery.easing/jquery.easing.min.js')); ?>"></script>
    ...
    <!-- ICO landing init -->
    <script src="<?php echo e(URL::asset('build/js/pages/ico-landing.init.js')); ?>"></script>
...
<?php /**PATH E:\xampp\htdocs\evolve.com\resources\views\admin\crypto-ico-landing.blade.php ENDPATH**/ ?>