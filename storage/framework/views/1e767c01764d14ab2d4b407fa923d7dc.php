...
unset($__sessionArgs); ?>
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                ...
                                <a href="<?php echo e(route('admin.specialization.add')); ?>"
                                    class="btn btn-success btn-rounded waves-effect waves-light addContact-modal mb-2"><i
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $specializations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specialization): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($specialization->specialization_name); ?></td> <!-- Trainer's name -->


                                        <td>
                                            <?php if($specialization->status == 'Y'): ?>
                                                <!-- Deactivate Button -->
                                                <button onclick="confirmDeactivate(<?php echo e($specialization->id); ?>)"
                                                ...
                                                <form style="display:none"
                                                    id="deactivate_trainer_form_<?php echo e($specialization->id); ?>"
                                                    action="<?php echo e(route('admin.specialization.deactivate', $specialization->id)); ?>"
                                                    method="post">
                                                    <?php echo csrf_field(); ?>
                                                </form>
                                            <?php else: ?>
                                                <!-- Activate Button -->
                                                <button onclick="confirmActivate(<?php echo e($specialization->id); ?>)" type="button"
                                                    class="btn btn-sm btn-success waves-effect waves-light">
                                                    <i class="bx bx-check-circle font-size-16 align-middle me-2"></i>
                                                    Activate
                                                </button>
                                                <form style="display:none"
                                                    id="activate_trainer_form_<?php echo e($specialization->id); ?>"
                                                    action="<?php echo e(route('admin.specialization.activate', $specialization->id)); ?>"
                                                    method="post">
                                                    <?php echo csrf_field(); ?>
                                                </form>
                                            <?php endif; ?>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('admin.specialization.edit', $specialization->id)); ?>"
                                                class="btn btn-sm btn-success waves-effect waves-light">
                                                <i class="bx bx-edit font-size-16 align-middle me-2"></i> Edit
                                            </a>
                                            <button type="button" onclick="confirmDelete(<?php echo e($specialization->id); ?>)"
                                                class="btn btn-sm btn-danger waves-effect waves-light">
                                                <i class="bx bx-trash font-size-16 align-middle me-2"></i> Delete
                                            </button>
                                            <form style="display:hidden" id="delete_trainer_form_<?php echo e($specialization->id); ?>"
                                                action="<?php echo e(route('admin.specialization.delete', $specialization->id)); ?>"
                                                method="post">
                                                <?php echo csrf_field(); ?>
                                            </form>
                                        </td>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <?php echo e($specializations->onEachSide(1)->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views/admin/specialization/index.blade.php ENDPATH**/ ?>