                ...
                <div class="payment-information">
                  ...
                  <div class="log-group-box mb-64">
                    <div class="log-group d-flex">
                      ...
                      <label for="read-carefully">I have read and understood the <span class="color-primary cursr-pointer" data-bs-toggle="modal" data-bs-target="#staticBackdrop-902">Terms & Conditions</span></label>
                       <!-- Modal -->
                      <div class="modal fade" id="staticBackdrop-902" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdrop-902Label" aria-hidden="true">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views\user\html\monthly-pass-payment.blade.php ENDPATH**/ ?>