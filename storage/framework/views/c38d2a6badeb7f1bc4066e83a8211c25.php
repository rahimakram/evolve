...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.Cart'); ?>
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle mb-0 table-nowrap">
                            ...
                            <tbody>
                                <tr class="product">
                                    <td>
                                        <img src="<?php echo e(URL::asset('build/images/product/img-1.png')); ?>" alt="product-img" title="product-img"
                                            class="avatar-md" />
                                    </td>
                                    <td>
                                ...
                                <tr class="product">
                                    <td>
                                        <img src="<?php echo e(URL::asset('build/images/product/img-2.png')); ?>" alt="product-img" title="product-img"
                                            class="avatar-md" />
                                    </td>
                                    <td>
                                        <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail"
                                ...
                                <tr class="product">
                                    <td>
                                        <img src="<?php echo e(URL::asset('build/images/product/img-3.png')); ?>" alt="product-img" title="product-img"
                                            class="avatar-md" />
                                    </td>
                                    <td>
                                        <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail"
                                ...
                                <tr class="product">
                                    <td>
                                        <img src="<?php echo e(URL::asset('build/images/product/img-4.png')); ?>" alt="product-img" title="product-img"
                                            class="avatar-md" />
                                    </td>
                                    <td>
                                        <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail"
                                ...
                                <tr class="product">
                                    <td>
                                        <img src="<?php echo e(URL::asset('build/images/product/img-5.png')); ?>" alt="product-img" title="product-img"
                                            class="avatar-md" />
                                    </td>
                                    <td>
                                        <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail"
                                ...
                                <tr class="product">
                                    <td>
                                        <img src="<?php echo e(URL::asset('build/images/product/img-6.png')); ?>" alt="product-img" title="product-img"
                                            class="avatar-md" />
                                    </td>
                                    <td>
                                        <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views\admin\ecommerce-cart.blade.php ENDPATH**/ ?>