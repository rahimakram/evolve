...
unset($__sessionArgs); ?>
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                ...
                                <a href="<?php echo e(route('admin.teams.add')); ?>"
                                    class="btn btn-success btn-rounded waves-effect waves-light addContact-modal mb-2"><i
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $trainers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trainer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($trainer->name); ?></td> <!-- Trainer's name -->
                                        <td><?php echo e($trainer->contact == '' ? 'N/A' : $trainer->phone); ?></td>
                                        <!-- Trainer's contact -->
                                        ...
                                        <td><?php echo e($trainer->description ?? 'N/A'); ?></td> <!-- Trainer's description -->

                                        <td>
                                            <?php if($trainer->status == 'Y'): ?>
                                                <!-- Deactivate Button -->
                                                <button onclick="confirmDeactivate(<?php echo e($trainer->u_id); ?>)" type="button"
                                                    class="btn btn-sm btn-danger waves-effect waves-light">
                                                    <i class="bx bx-block font-size-16 align-middle me-2"></i> Deactivate
                                                </button>
                                                <form style="display:none" id="deactivate_trainer_form_<?php echo e($trainer->u_id); ?>"
                                                    action="<?php echo e(route('admin.teams.deactivate', $trainer->u_id)); ?>"
                                                    method="post">
                                                    <?php echo csrf_field(); ?>
                                                </form>
                                            <?php else: ?>
                                                <!-- Activate Button -->
                                                <button onclick="confirmActivate(<?php echo e($trainer->u_id); ?>)" type="button"
                                                    class="btn btn-sm btn-success waves-effect waves-light">
                                                    <i class="bx bx-check-circle font-size-16 align-middle me-2"></i>
                                                    Activate
                                                </button>
                                                <form style="display:none" id="activate_trainer_form_<?php echo e($trainer->u_id); ?>"
                                                    action="<?php echo e(route('admin.teams.activate', $trainer->u_id)); ?>"
                                                    method="post">
                                                    <?php echo csrf_field(); ?>
                                                </form>
                                            <?php endif; ?>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('admin.teams.edit', $trainer->u_id)); ?>"
                                                class="btn btn-sm btn-success waves-effect waves-light">
                                                <i class="bx bx-edit font-size-16 align-middle me-2"></i> Edit
                                            </a>
                                            <button type="button" onclick="confirmDelete(<?php echo e($trainer->u_id); ?>)"
                                                class="btn btn-sm btn-danger waves-effect waves-light">
                                                <i class="bx bx-trash font-size-16 align-middle me-2"></i> Delete
                                            </button>
                                            <form style="display:hidden" id="delete_trainer_form_<?php echo e($trainer->u_id); ?>"
                                                action="<?php echo e(route('admin.teams.delete', $trainer->u_id)); ?>" method="post">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views/admin/team/index.blade.php ENDPATH**/ ?>