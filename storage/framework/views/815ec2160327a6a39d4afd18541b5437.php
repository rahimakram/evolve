...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.Job_Grid'); ?>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(URL::asset('build/images/companies/adobe.svg')); ?>" alt="" height="50" class="mb-3">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(URL::asset('build/images/companies/adobe-photoshop.svg')); ?>" alt="" height="50" class="mb-3">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(URL::asset('build/images/companies/airbnb.svg')); ?>" alt="" height="50" class="mb-3">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(URL::asset('build/images/companies/amazon.svg')); ?>" alt="" height="50" class="mb-3">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(URL::asset('build/images/companies/flutter.svg')); ?>" alt="" height="50" class="mb-3">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(URL::asset('build/images/companies/mailchimp.svg')); ?>" alt="" height="50" class="mb-3">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(URL::asset('build/images/companies/line.svg')); ?>" alt="" height="50" class="mb-3">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(URL::asset('build/images/companies/spotify.svg')); ?>" alt="" height="50" class="mb-3">
                    <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small
                            class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(URL::asset('build/images/companies/wordpress.svg')); ?>" alt="" height="50" class="mb-3">
                    <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small
                            class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(URL::asset('build/images/companies/upwork.svg')); ?>" alt="" height="50" class="mb-3">
                    <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small
                            class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(URL::asset('build/images/companies/sass.svg')); ?>" alt="" height="50" class="mb-3">
                    <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small
                            class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(URL::asset('build/images/companies/reddit.svg')); ?>" alt="" height="50" class="mb-3">
                    <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small
                            class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views\admin\job-grid.blade.php ENDPATH**/ ?>