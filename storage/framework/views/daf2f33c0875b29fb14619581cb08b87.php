...
unset($__sessionArgs); ?>
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                ...
                                <a href="<?php echo e(route('admin.location.add')); ?>"
                                    class="btn btn-success btn-rounded waves-effect waves-light addContact-modal mb-2"><i
                                        class="mdi mdi-plus me-1"></i> Create Location</a>
                            </div>
                        </div><!-- end col-->
                    </div>
                    <!-- end row -->
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(!empty($location->activity_names)): ?>
                                                <?php echo e(implode(', ', $location->activity_names->toArray())); ?>
                                        ...
                                        <td><img class="rounded-circle header-profile-user"
                                                src="<?php echo e(asset('storage/' . $location->logo)); ?>" alt="Header Avatar"></td>
                                        <td><img class="rounded-circle header-profile-user"
                                                src="<?php echo e(asset('storage/' . $location->image)); ?>" alt="Header Avatar"></td>


                                        <td>
                                            <?php if($location->status == 'Y'): ?>
                                                <!-- Deactivate Button -->
                                                <button onclick="confirmDeactivate(<?php echo e($location->id); ?>)" type="button"
                                                    class="btn btn-sm btn-danger waves-effect waves-light">
                                                    <i class="bx bx-block font-size-16 align-middle me-2"></i> Deactivate
                                                </button>
                                                <form style="display:none" id="deactivate_trainer_form_<?php echo e($location->id); ?>"
                                                    action="<?php echo e(route('admin.location.deactivate', $location->id)); ?>"
                                                    method="post">
                                                    <?php echo csrf_field(); ?>
                                                </form>
                                            <?php else: ?>
                                                <!-- Activate Button -->
                                                <button onclick="confirmActivate(<?php echo e($location->id); ?>)" type="button"
                                                    class="btn btn-sm btn-success waves-effect waves-light">
                                                    <i class="bx bx-check-circle font-size-16 align-middle me-2"></i>
                                                    Activate
                                                </button>
                                                <form style="display:none" id="activate_trainer_form_<?php echo e($location->id); ?>"
                                                    action="<?php echo e(route('admin.location.activate', $location->id)); ?>"
                                                    method="post">
                                                    <?php echo csrf_field(); ?>
                                                </form>
                                            <?php endif; ?>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('admin.location.edit', $location->id)); ?>"
                                                class="btn btn-sm btn-success waves-effect waves-light">
                                                <i class="bx bx-edit font-size-16 align-middle me-2"></i> Edit
                                            </a>
                                            <button type="button" onclick="confirmDelete(<?php echo e($location->id); ?>)"
                                                class="btn btn-sm btn-danger waves-effect waves-light">
                                                <i class="bx bx-trash font-size-16 align-middle me-2"></i> Delete
                                            </button>
                                            <form style="display:hidden" id="delete_trainer_form_<?php echo e($location->id); ?>"
                                                action="<?php echo e(route('admin.location.delete', $location->id)); ?>"
                                                method="post">
                                                <?php echo csrf_field(); ?>
                                            </form>
                                        </td>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <?php echo e($locations->onEachSide(1)->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views\admin\location\index.blade.php ENDPATH**/ ?>