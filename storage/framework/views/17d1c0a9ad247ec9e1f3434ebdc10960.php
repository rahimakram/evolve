...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card">
                <img class="card-img img-fluid" src="<?php echo e(URL::asset('build/images/small/img-6.jpg')); ?>" alt="Card image">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="row no-gutters align-items-center">
                    <div class="col-md-4">
                        <img class="card-img img-fluid" src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" alt="Card image">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-md-4">
                        <img class="card-img img-fluid" src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" alt="Card image">
                    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="row" data-masonry='{"percentPosition": true }'>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card">
                        <img src="<?php echo e(URL::asset('build/images/small/img-5.jpg')); ?>" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card">
                        <img src="<?php echo e(URL::asset('build/images/small/img-7.jpg')); ?>" class="card-img-top" alt="...">
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views\admin\ui-cards.blade.php ENDPATH**/ ?>