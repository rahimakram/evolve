            ...
            <div class="row" id="product-list">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="product-img position-relative">
                                ...
                                <img src="<?php echo e(URL::asset('build/images/product/img-1.png')); ?>" alt=""
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="product-img position-relative">
                                <img src="<?php echo e(URL::asset('build/images/product/img-2.png')); ?>" alt=""
                                    class="img-fluid mx-auto d-block">
                            </div>
                            <div class="mt-4 text-center">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="product-img position-relative">
                                ...
                                <img src="<?php echo e(URL::asset('build/images/product/img-3.png')); ?>" alt=""
                                    class="img-fluid mx-auto d-block">
                            </div>
                            <div class="mt-4 text-center">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="product-img position-relative">
                                ...
                                <img src="<?php echo e(URL::asset('build/images/product/img-5.png')); ?>" alt=""
                                    class="img-fluid mx-auto d-block">
                            </div>
                            <div class="mt-4 text-center">
                                <h5 class="mb-3 text-truncate"><a href="javascript: void(0);" class="text-dark">Half
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="product-img position-relative">
                                ...
                                <img src="<?php echo e(URL::asset('build/images/product/img-6.png')); ?>" alt=""
                                    class="img-fluid mx-auto d-block">
                            </div>
                            <div class="mt-4 text-center">
...
<?php $__env->startSection('script'); ?>
    ...
    <!-- init js -->
    <script src="<?php echo e(URL::asset('build/js/pages/product-list.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views\admin\ecommerce-products.blade.php ENDPATH**/ ?>