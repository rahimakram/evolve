            ...
            <div class="row">
                <div class="col-12 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="2s">
                    ...
                    <div class="mxw-800">
                        ...
                        <p>The ultimate hub for all your organization’s wellness needs. We provide comprehensive resources and support for your employees’ health and wellbeing journeys.</p>
                    </div>
                </div>
            </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row mb-64">
          <div class="col-md-4 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="2s">
            <div class="card">
              <img src="<?php echo e(URL::asset('dist/images/wellness/wellness-1.png')); ?>" class="img-fluid" alt="...">
              <div class="card-body">
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="2s">
            <div class="card">
              <img src="<?php echo e(URL::asset('dist/images/wellness/wellness-2.png')); ?>" class="img-fluid" alt="...">
              <div class="card-body">
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="2s">
            <div class="card">
              <img src="<?php echo e(URL::asset('dist/images/wellness/wellness-3.png')); ?>" class="img-fluid" alt="...">
              <div class="card-body">
        ...
        <div class="row mb-64">
          <div class="col-md-4 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="2s">
            <div class="card">
              <img src="<?php echo e(URL::asset('dist/images/wellness/wellness-4.png')); ?>" class="img-fluid" alt="...">
              <div class="card-body">
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="2s">
            <div class="card">
              <img src="<?php echo e(URL::asset('dist/images/wellness/wellness-5.png')); ?>" class="img-fluid" alt="...">
              <div class="card-body">
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="2s">
            <div class="card">
              <img src="<?php echo e(URL::asset('dist/images/wellness/wellness-6.png')); ?>" class="img-fluid" alt="...">
              <div class="card-body">
        ...
        <div class="row mb-64">
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="2s">
            <div class="card">
              <img src="<?php echo e(URL::asset('dist/images/wellness/wellness-12.png')); ?>" class="img-fluid" alt="...">
              <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="2s">
            <div class="card">
              <img src="<?php echo e(URL::asset('dist/images/wellness/wellness-13.png')); ?>" class="img-fluid" alt="...">
              <div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views\user\html\wellness-in-the-workplace.blade.php ENDPATH**/ ?>