                ...
                <div class="row">
                    <div class="col-6">
                        <div>
                            ...
                            <a class="image-popup-vertical-fit" href="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" title="Caption. Can be aligned it to any side and contain any HTML.">
                                <img class="img-fluid" alt="" src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" width="145">
                            </a>
                        </div>
                    </div>
                    <div class="col-6">
                        <div>
                            ...
                            <a class="image-popup-no-margins" href="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>">
                                <img class="img-fluid" alt="" src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" width="75">
                            </a>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="popup-gallery d-flex flex-wrap">
                    <a href="<?php echo e(URL::asset('build/images/small/img-1.jpg')); ?>" title="Project 1">
                        <div class="img-fluid">
                            <img src="<?php echo e(URL::asset('build/images/small/img-1.jpg')); ?>" alt="" width="120">
                        </div>
                    </a>
                    <a href="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" title="Project 2">
                        <div class="img-fluid">
                            <img src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" alt="" width="120">
                        </div>
                    </a>
                    <a href="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" title="Project 3">
                        <div class="img-fluid">
                            <img src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" alt="" width="120">
                        </div>
                    </a>
                    <a href="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>" title="Project 4">
                        <div class="img-fluid">
                            <img src="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>" alt="" width="120">
                        </div>
                    </a>
                    <a href="<?php echo e(URL::asset('build/images/small/img-5.jpg')); ?>" title="Project 5">
                        <div class="img-fluid">
                            <img src="<?php echo e(URL::asset('build/images/small/img-5.jpg')); ?>" alt="" width="120">
                        </div>
                    </a>
                    <a href="<?php echo e(URL::asset('build/images/small/img-6.jpg')); ?>" title="Project 6">
                        <div class="img-fluid">
                            <img src="<?php echo e(URL::asset('build/images/small/img-6.jpg')); ?>" alt="" width="120">
                        </div>
                    </a>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="zoom-gallery d-flex flex-wrap">
                    <a href="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" title="Project 1"><img src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" alt="" width="275"></a>
                    <a href="<?php echo e(URL::asset('build/images/small/img-7.jpg')); ?>" title="Project 2"><img src="<?php echo e(URL::asset('build/images/small/img-7.jpg')); ?>" alt="" width="275"></a>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views\admin\ui-lightbox.blade.php ENDPATH**/ ?>