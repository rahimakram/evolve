            ...
            <div class="row">
                <div class="col-12 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="2s">
                    ...
                    <div class="mxw-800">
                        ...
                        <p>Evolve is committed to supporting Qatar's environmental, social, and corporate governance (ESG) development by offering a range of workshops designed to help companies meet their objectives.</p>
                    </div>
                </div>
            </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row mb-64">
          <div class="col-md-4 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="2s">
            <div class="card">
              <img src="<?php echo e(URL::asset('dist/images/ESG/esg-1.png')); ?>" class="img-fluid" alt="...">
              <div class="card-body">
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="2s">
            <div class="card">
              <img src="<?php echo e(URL::asset('dist/images/ESG/esg-2.png')); ?>" class="img-fluid" alt="...">
              <div class="card-body">
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="2s">
            <div class="card">
              <img src="<?php echo e(URL::asset('dist/images/ESG/esg-3.png')); ?>" class="img-fluid" alt="...">
              <div class="card-body">
        ...
        <div class="row mb-64">
          <div class="col-md-4 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="2s">
            <div class="card">
              <img src="<?php echo e(URL::asset('dist/images/ESG/esg-4.png')); ?>" class="img-fluid" alt="...">
              <div class="card-body">
                <h5 class="card-title">The Ultimate Ramadan Gathering</h5>
                <p class="card-text">This gathering has been designed for both Muslims and non-Muslims. For the non-Muslims it will provide insights on Muslim culture helping them to better understand the spiritual significance and to learn about etiquettes of Ramadan practices. For Muslims it will provide a fresh approach to the holy month in terms in creating sustainable health, fitness and wellbeing routines aligned with spiritual goals. This could be part of a Teams iftar or Suhoor.</p>                
              </div>
            </div>
          </div>
          <div class="col-md-4 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="2s">
            <div class="card">
              <img src="<?php echo e(URL::asset('dist/images/ESG/esg-5.png')); ?>" class="img-fluid" alt="...">
              <div class="card-body">
                <h5 class="card-title">International Earth Day - Planet Rescue Workshop</h5>
                <p class="card-text">This workshop will encourage environmentally conscious practices in the workplace that support employees to feel healthier, more satisfied with the environment they work in, and more driven to thrive at work. The Pledge - everyone who attends the workshop is accountable for their actions, by taking this pledge each employee commits to doing their part to save the planet. The workshop and its impact will leave a lasting impression of environmental impact for the organization as part of its contribution to the Environmental Development Pillar of the Qatar National Vision 2030.</p>                
              </div>
            </div>
          </div>
          <div class="col-md-4 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="2s">
            <div class="card">
              <img src="<?php echo e(URL::asset('dist/images/ESG/esg-6.png')); ?>" class="img-fluid" alt="...">
              <div class="card-body">
                <h5 class="card-title">Work Life Balance</h5>
                <p class="card-text">In our quest to meet life's demands, we often find ourselves on the brink of exhaustion and burnout. This session is dedicated to helping you identify key priorities and develop strategies for a fulfilling life with balance. We'll explore the impacts of imbalance on life satisfaction, the various aspects of wellbeing, and simple techniques for managing activities to let go of burdens. Discover how to identify and eliminate energy-draining elements, freeing up mental and physical energy through simplification and decluttering strategies.</p>
              </div>
            </div>
          </div>
        </div>
        <div class="row mb-64">
          <div class="col-md-4 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="2s">
            <div class="card">
              <img src="<?php echo e(URL::asset('dist/images/ESG/esg-7.png')); ?>" class="img-fluid" alt="...">
              <div class="card-body">
                <h5 class="card-title">World Oceans Day - Beach BBQ</h5>
                <p class="card-text">This annual celebration is an opportunity to unite around our love and dedication for this blue planet. Providing an afternoon for your team to bond in an interactive discussion on Qatar’s marine ecosystems (the breeding home for Whale Sharks) along with a BBQ dinner and a splash around in Qatar’s Arabian sea.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="2s">
            <div class="card">
              <img src="<?php echo e(URL::asset('dist/images/ESG/esg-8.png')); ?>" class="img-fluid" alt="...">
              <div class="card-body">
                <h5 class="card-title">International Day of Friendship</h5>
                <p class="card-text">Join us for an after-office gathering filled with fun icebreakers and games designed to help you get to know your colleagues better! Afterward, enjoy light snacks and drinks as you relax and mingle. It's the perfect way to unwind and connect with your team outside of work.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="2s">
            <div class="card">
              <img src="<?php echo e(URL::asset('dist/images/ESG/esg-9.png')); ?>" class="img-fluid" alt="...">
              <div class="card-body">
                <h5 class="card-title">Why Your Workspace Matters</h5>
                <p class="card-text">A well-designed working space plays an important role in working culture, workflow, and overall productivity. An Interior Designer will discuss how your immediate environment can impact your mood and daily productivity, enhancing your space to maximize on efficiency and creativity in this engaging workshop.</p>
              </div>
            </div>
          </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views/user/environmental-social-governance.blade.php ENDPATH**/ ?>