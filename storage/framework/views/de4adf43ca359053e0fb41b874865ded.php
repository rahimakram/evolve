                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5">
                                    <a href="/index" class="d-block auth-logo">
                                        <img src="<?php echo e(URL::asset('build/images/logo.webp')); ?>" alt="" height="18" class="auth-logo-dark">
                                        <img src="<?php echo e(URL::asset('build/images/logo.webp')); ?>" alt="" height="18" class="auth-logo-light">
                                    </a>
                                </div>
                                <div class="my-auto">
...
<?php echo $__env->make('admin.layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views\admin\auth\passwords\reset.blade.php ENDPATH**/ ?>