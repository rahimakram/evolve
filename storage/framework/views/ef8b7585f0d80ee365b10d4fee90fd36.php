        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="<?php echo e(route('admin.activity.update', $activity->id)); ?>"
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="activity_name" name="activity_name"
                                        ...
                                        value="<?php echo e(old('activity_name') ? old('activity_name') : $activity->activity_name); ?>">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views\admin\activity\edit.blade.php ENDPATH**/ ?>