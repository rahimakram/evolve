        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="<?php echo e(route('admin.timeline.update', $timeline->id)); ?>"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title"
                                        ...
                                        value="<?php echo e(old('title') ? old('title') : $timeline->title); ?>">
                                    ...
                                    <select class="form-select" name="location" id="location">
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <option value="<?php echo e($location->id); ?>"
                                                <?php echo e($location->id == $timeline->location_id ? 'selected' : ''); ?>>
                                    ...
                                    <select class="form-select" name="instructor" id="instructor">
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $instructors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instructor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <option value="<?php echo e($instructor->id); ?>"
                                                <?php echo e($timeline->instructor_id == $instructor->id ? 'selected' : ''); ?>>
                                    ...
                                    <select class="select2 form-control select2-multiple" id="activities"
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <option value="<?php echo e($activity->id); ?>"
                                                <?php echo e(in_array($activity->id, $selectedActivities) ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea id="description-editor" name="description" class="form-control" rows="3" id="description"
                                        placeholder="Enter Your Description"><?php echo e(old('description') ? old('description') : $timeline->description); ?></textarea>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="date" name="date"
                                        value="<?php echo e(old('date') ? old('date') : \Carbon\Carbon::parse($timeline->date)->format('Y-m-d')); ?>"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="time" name="time"
                                        value="<?php echo e(old('time') ? old('time') : \Carbon\Carbon::parse($timeline->time)->format('H:i:s')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <?php if($timeline->image): ?>
                                    <img id="image-preview" src="<?php echo e(asset('storage/' . $timeline->image)); ?>"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views\admin\timeline\edit.blade.php ENDPATH**/ ?>