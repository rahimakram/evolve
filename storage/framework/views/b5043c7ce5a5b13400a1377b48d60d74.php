        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="<?php echo e(url('/admin/dashboard')); ?>" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?php echo e(URL::asset('build/images/favicon.webp')); ?>" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(URL::asset('build/images/logo.webp')); ?>" alt="" height="17">
                    </span>
                </a>
...
<!-- <?php echo e(asset('storage/' . Auth::user()->avatar)); ?> -->
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user"
                        src="<?php echo e(isset(Auth::user()->avatar) ? asset('storage/' . Auth::user()->avatar) : asset('build/images/users/avatar-1.jpg')); ?>"
                        alt="Header Avatar">
...
<?php /**PATH E:\xampp\htdocs\evolve.com\resources\views/admin/layouts/topbar.blade.php ENDPATH**/ ?>