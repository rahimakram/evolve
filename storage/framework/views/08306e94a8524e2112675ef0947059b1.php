...
<?php $__env->startSection('content'); ?>
                      ...
                      <div class="modal-dialog mxw-800 text-center">
                        <div class="modal-content ptb-88-98">
                          ...
                          <div class="loc-model-body">
                            ...
                            <div class="location-video">
                              <img src="<?php echo e(URL::asset('dist/images/location/location-video-1.png')); ?>" class="img-fluid" alt="">
                            </div>
                          </div>
                        </div>
                      </div>
    ...
    <section class="evole-map">
      <div id="map">
        <img src="<?php echo e(URL::asset('dist/images/location/map.png')); ?>" class="img-fluid" alt="">
      </div>
    </section>
