        ...
        <div class="tab-content" id="nav-tabContent">
          ...
          <div class="tab-pane fade show active" id="locations-all" role="tabpanel" aria-labelledby="locations-all-tab">
            <div class="row mb-64">
              <div class="col-md-3">
                ...
                <div class="card btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop-01">
                  <img src="./dist/images/location/location-1.png" class="img-fluid" alt="...">
                  <div class="card-body">
                  ...
                  <div class="modal-dialog mxw-800 text-center">
                    <div class="modal-content ptb-88-98">
                      ...
                      <div class="loc-model-body">
                        <div class="loc-model-img mb-24"><img src="./dist/images/location/mandarin-oriental.png" class="img-fluid" alt=""></div>
                        <h2>Mandarin Oriental</h2>
                        <h6 class="mb-24">Msheireb <span class="px-3">.</span><span class="pe-2">View map</span><span><img src="./dist/images/arrow-top.png" class="img-fluid" alt=""></span></h6>
                        ...
                        <div class="location-video">
                          <img src="./dist/images/location/location-video-1.png" class="img-fluid" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-md-3">
                <div class="card btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop-02">
                  <img src="./dist/images/location/location-2.png" class="img-fluid" alt="...">
                  <div class="card-body">
              ...
              <div class="col-md-3">
                <div class="card">
                  <img src="./dist/images/location/location-3.png" class="img-fluid" alt="...">
                  <div class="card-body">
              ...
              <div class="col-md-3">
                <div class="card">
                  <img src="./dist/images/location/location-4.png" class="img-fluid" alt="...">
                  <div class="card-body">
            ...
            <div class="row mb-64">
              <div class="col-md-3">
                <div class="card">
                  <img src="./dist/images/location/location-5.png" class="img-fluid" alt="...">
                  <div class="card-body">
              ...
              <div class="col-md-3">
                <div class="card">
                  <img src="./dist/images/location/location-6.png" class="img-fluid" alt="...">
                  <div class="card-body">
              ...
              <div class="col-md-3">
                <div class="card">
                  <img src="./dist/images/location/location-7.png" class="img-fluid" alt="...">
                  <div class="card-body">
              ...
              <div class="col-md-3">
                <div class="card">
                  <img src="./dist/images/location/location-8.png" class="img-fluid" alt="...">
                  <div class="card-body">
            ...
            <div class="row mb-64">
              <div class="col-md-3">
                <div class="card">
                  <img src="./dist/images/location/location-9.png" class="img-fluid" alt="...">
                  <div class="card-body">
          ...
          <div class="tab-pane fade" id="loc-pilates" role="tabpanel" aria-labelledby="loc-pilates-tab">
            <div class="row mb-64">
              <div class="col-md-3">
                <div class="card">
                  <img src="./dist/images/team/Checker.png" class="img-fluid" alt="...">
                  <div class="card-body">
