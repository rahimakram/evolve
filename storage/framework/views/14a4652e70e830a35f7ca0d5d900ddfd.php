...
unset($__sessionArgs); ?>
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                <a href="<?php echo e(route('admin.timeline.add')); ?>"
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $timelines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timeline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($timeline->title); ?></td> <!-- Trainer's name -->
                                        <td><?php echo e($timeline->location_name ? $timeline->location_name : 'N/A'); ?></td>
                                        <!-- Trainer's contact -->
                                        <td><?php echo e($timeline->instructor_name ?? 'N/A'); ?></td> <!-- Trainer's email -->
                                        <td><?php echo e($timeline->date ?? 'N/A'); ?>

                                            
                                        </td> <!-- Trainer's specialization -->

                                        <td><img class="rounded-circle header-profile-user"
                                                src="<?php echo e(asset('storage/' . $timeline->image)); ?>"></td>
                                        <!-- Trainer's description -->

                                        <td>
                                            <?php if($timeline->status == 'Y'): ?>
                                                <!-- Deactivate Button -->
                                                <button onclick="confirmDeactivate(<?php echo e($timeline->id); ?>)" type="button"
                                                    class="btn btn-sm btn-danger waves-effect waves-light">
                                                    <i class="bx bx-block font-size-16 align-middle me-2"></i> Deactivate
                                                </button>
                                                <form style="display:none" id="deactivate_trainer_form_<?php echo e($timeline->id); ?>"
                                                    action="<?php echo e(route('admin.timeline.deactivate', $timeline->id)); ?>"
                                                    method="post">
                                                    <?php echo csrf_field(); ?>
                                                </form>
                                            <?php else: ?>
                                                <!-- Activate Button -->
                                                <button onclick="confirmActivate(<?php echo e($timeline->id); ?>)" type="button"
                                                    class="btn btn-sm btn-success waves-effect waves-light">
                                                    <i class="bx bx-check-circle font-size-16 align-middle me-2"></i>
                                                    Activate
                                                </button>
                                                <form style="display:none" id="activate_trainer_form_<?php echo e($timeline->id); ?>"
                                                    action="<?php echo e(route('admin.timeline.activate', $timeline->id)); ?>"
                                                    method="post">
                                                    <?php echo csrf_field(); ?>
                                                </form>
                                            <?php endif; ?>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('admin.timeline.edit', $timeline->id)); ?>"
                                                class="btn btn-sm btn-success waves-effect waves-light">
                                                <i class="bx bx-edit font-size-16 align-middle me-2"></i> Edit
                                            </a>
                                            <button type="button" onclick="confirmDelete(<?php echo e($timeline->id); ?>)"
                                                class="btn btn-sm btn-danger waves-effect waves-light">
                                                <i class="bx bx-trash font-size-16 align-middle me-2"></i> Delete
                                            </button>
                                            <form style="display:hidden" id="delete_trainer_form_<?php echo e($timeline->id); ?>"
                                                action="<?php echo e(route('admin.timeline.delete', $timeline->id)); ?>"
                                                method="post">
                                                <?php echo csrf_field(); ?>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <?php echo e($timelines->onEachSide(1)->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views\admin\timeline\index.blade.php ENDPATH**/ ?>