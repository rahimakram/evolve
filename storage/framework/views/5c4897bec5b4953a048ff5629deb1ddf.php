                ...
                <div class="card-body">
                    <div class="invoice-title">
                        ...
                        <div class="auth-logo mb-4">
                            <img src="<?php echo e(URL::asset('build/images/logo.webp')); ?>" alt="logo" class="auth-logo-dark" height="20" />
                            <img src="<?php echo e(URL::asset('build/images/logo.webp')); ?>" alt="logo" class="auth-logo-light" height="20" />
                        </div>
                    </div>
                    <hr>
                    <div class="row">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views\admin\invoices-detail.blade.php ENDPATH**/ ?>