...
<?php $__env->startSection('css'); ?>
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('build/libs/tui-time-picker/tui-time-picker.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('build/libs/tui-date-picker/tui-date-picker.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('build/libs/tui-calendar/tui-calendar.min.css')); ?>" />
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('build/libs/tui-dom/tui-dom.min.js')); ?>"></script>

    <script src="<?php echo e(URL::asset('build/libs/tui-time-picker/tui-time-picker.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('build/libs/tui-date-picker/tui-date-picker.min.js')); ?>"></script>

    <script src="<?php echo e(URL::asset('build/libs//moment/min/moment.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('build/libs/chance/chance.min.js')); ?>"></script>

    <script src="<?php echo e(URL::asset('build/libs/tui-calendar/tui-calendar.min.js')); ?>"></script>

    <script src="<?php echo e(URL::asset('build/js/pages/calendars.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('build/js/pages/schedules.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('build/js/pages/calendar.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views\admin\calendar.blade.php ENDPATH**/ ?>