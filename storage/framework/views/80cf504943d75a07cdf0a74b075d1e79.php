...
<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.Candidate'); ?> <?php echo app('translator')->get('translation.Overview'); ?> <?php $__env->stopSection(); ?>
        ...
        <div class="card mx-n4 mt-n4 bg-info-subtle">
            <div class="card-body">
                <div class="text-center mb-4">
                    <img src="<?php echo e(URL::asset('build/images/users/avatar-6.jpg')); ?>" alt="" class="avatar-md rounded-circle mx-auto d-block" />
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views\admin\candidate-overview.blade.php ENDPATH**/ ?>