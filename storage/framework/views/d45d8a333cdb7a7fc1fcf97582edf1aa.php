        ...
        <div class="ptb-64">
          ...
          <div class="row mb-32">
            <div class="col-md-3 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="2s">
              <div class="card">
                <div class="card-img-box">
                <img src="<?php echo e(URL::asset('dist/images/fitness-training/training-5.png')); ?>" class="img-fluid" alt="...">
                </div>
                <div class="card-body">
            ...
            <div class="col-md-3 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="2s">
              <div class="card">
                <div class="card-img-box">
                <img src="<?php echo e(URL::asset('dist/images/fitness-training/training-6.png')); ?>" class="img-fluid" alt="...">
                </div>
                <div class="card-body">
            ...
            <div class="col-md-3 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="2s">
              <div class="card">
                <div class="card-img-box">
                <img src="<?php echo e(URL::asset('dist/images/fitness-training/training-7.png')); ?>" class="img-fluid" alt="...">
                </div>
                <div class="card-body">
            ...
            <div class="col-md-3 wow fadeInUp" data-wow-delay="700ms" data-wow-duration="2s">
              <div class="card">
                <div class="card-img-box">
                <img src="<?php echo e(URL::asset('dist/images/fitness-training/training-8.png')); ?>" class="img-fluid" alt="...">
                </div>
                <div class="card-body">
        ...
        <div class="ptb-64">
          ...
          <div class="row">
            ...
            <div class="col-md-3 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="2s">
              <div class="card">
                <div class="card-img-box">
                <img src="<?php echo e(URL::asset('dist/images/fitness-training/t-loc-7.png')); ?>" class="img-fluid" alt="...">
                </div>
                <div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views\user\html\fitness-training.blade.php ENDPATH**/ ?>