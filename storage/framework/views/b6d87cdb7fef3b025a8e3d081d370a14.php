...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.Dropdowns'); ?>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">By default, the dropdown menu is closed when clicking inside or outside the
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        ...
                        <div class="btn-group">
                            <div class="btn-group dropstart">
                                <button type="button"
                                    class="btn btn-info dropdown-toggle waves-effect waves-light dropdown-toggle-split"
                                    data-bs-toggle="dropdown" aria-expanded="false">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views\admin\ui-dropdowns.blade.php ENDPATH**/ ?>