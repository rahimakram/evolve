...
unset($__sessionArgs); ?>
                    ...
                    <form method="post" action="<?php echo e(route('admin.teams.create')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="trainer_name" name="trainer_name"
                                        placeholder="Enter Your Name" value="<?php echo e(old('trainer_name')); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="trainer_contact" name="trainer_contact"
                                        placeholder="Enter Your Contact Number" value="<?php echo e(old('trainer_contact')); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" name="trainer_email" id="trainer_email"
                                        placeholder="Enter Your Email ID" value="<?php echo e(old('trainer_email')); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea required="" name="special_focus_area" class="form-control" rows="3" id="special_focus_area"
                                        placeholder="Enter Your Special Focus Area"><?php echo e(old('special_focus_area')); ?></textarea>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea required="" name="experience" class="form-control" rows="3" id="experience"
                                        placeholder="Enter Your Experience"><?php echo e(old('experience')); ?></textarea>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea required="" name="certification" class="form-control" rows="3" id="certification"
                                        placeholder="Enter Your Certification"><?php echo e(old('certification')); ?></textarea>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea required="" name="classes" class="form-control" rows="3" id="classes"
                                        placeholder="Enter Your Classes"><?php echo e(old('classes')); ?></textarea>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea required="" name="education" class="form-control" rows="3" id="education"
                                        placeholder="Enter Your Education"><?php echo e(old('education')); ?></textarea>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea required="" name="languages" class="form-control" rows="3" id="languages"
                                        placeholder="Enter Your Languages"><?php echo e(old('languages')); ?></textarea>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\evolve.com\resources\views/admin/team/add.blade.php ENDPATH**/ ?>